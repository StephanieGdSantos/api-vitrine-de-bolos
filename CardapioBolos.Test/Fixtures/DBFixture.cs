...
namespace CardapioBolos.Test.Fixtures
{
    public class DBFixture : IDisposable
    {
        ...
        private void InserirDados()
        {
            ...
            var bolo1 = new Bolo("Bolo de Cenoura", "https://www.receiteria.com.br/wp-content/uploads/receitas-de-bolo-de-cenoura-1-730x449.jpg", "Bolo de cenoura com cobertura de chocolate", new List<Ingrediente>(), 20.0);
            var bolo2 = new Bolo("Bolo de Chocolate", "https://www.receiteria.com.br/wp-content/uploads/receitas-de-bolo-de-chocolate-1-730x449.jpg", "Bolo de chocolate com cobertura de chocolate", new List<Ingrediente>(), 25.0);
